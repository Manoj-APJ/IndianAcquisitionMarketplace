        ...
        <div className="min-h-screen bg-white">
            <div className="container mx-auto px-4 py-12 max-w-3xl">
                ...
                <article className="prose prose-lg prose-headings:font-black prose-a:text-blue-600 prose-img:border-2 prose-img:border-black prose-img:shadow-neo max-w-none">
                    ...
                    {/* Note: In prod, use a markdown renderer like react-markdown. 
                 For simplicity here we assume content is HTML or we'd just render text if markdown.
                 Ideally: <Markdown>{post.content}</Markdown> */}
                </article>
            </div>
        </div>
    );
