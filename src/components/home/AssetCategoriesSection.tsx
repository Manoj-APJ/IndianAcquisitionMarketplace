        ...
        <section className="py-24 bg-gray-50 border-b-2 border-black">
            <div className="container mx-auto px-4 max-w-6xl">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-black mb-4 uppercase tracking-tighter">Browse by Category</h2>
                    <p className="text-xl text-gray-500 font-bold">Discover profitable digital real estate across all niches.</p>
                </div>
